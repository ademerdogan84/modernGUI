...
button_e = Button(root, text="=", padx=90, pady=20, command=button_equal)
button_c = Button(root, text="Clear", padx=79, pady=20, command=button_clear)
button_s = Button(root, text="-", padx=41, pady=20, command=button_subtract)
button_m = Button(root, text="*", padx=40, pady=20, command=button_multiply)
button_d = Button(root, text="/", padx=41, pady=20, command=button_divide)
